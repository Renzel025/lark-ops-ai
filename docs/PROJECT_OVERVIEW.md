...
- Optional: **Issue Watch** (auto-detect player issues in chat), **Grafana screenshots**, **Bitable deployment cards**, **VC ring**, **severity Major/Minor**, and more
...
| Severity DM | `P0_SEVERITY_PROMPT_ENABLED`, `LARK_SEVERITY_APP_ID` |
...
5. Optional **Major/Minor severity** DM via second Lark app
6. Optional **VC ring** when duty joins meeting
