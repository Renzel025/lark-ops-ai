...
#   sosm = liveslot SRE duty (Liveslot section of the OSE & SRE Duty Shift sheet).
# Matched against the text AFTER the leading @bot mention is stripped.
RING_CMD_RE = re.compile(r"^(m|e|scpms|sfpms|sfe|spms|fe|fpms|cpms|pms|dba|sosm)$", re.IGNORECASE)
